...
WebFontConfig = {
  ...
  // this.game.load.setPreloadSprite(this.preloadBar);
        ...
        this.game.load.image('game-instructions', 'assets/menus/instructions-ita-p1.png');
        this.game.load.image('game-intro-pic', 'assets/menus/intro-title-pic.jpg');
        this.game.load.image('game-instructions-2', 'assets/menus/instructions-ita-p2.png');
