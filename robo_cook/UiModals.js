class UiModalsManager {
    ...
    showFinishedRecipe(){
        Swal.fire({
            title: "La ricetta è pronta!\nGiochiamo ancora!",
            html: "<b style='color:green;font-size: 24px;'>Continuate a giocare, cambiate ruoli, rispondete ad altre domande e preparate nuove ricette.</b>",
            timer: 700000,
            backdrop: true,
